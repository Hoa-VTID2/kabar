...
class NotificationRepositoryImpl implements NotificationRepository {
  ...
  Future<Result<List<NotificationItem>>> getNotifications(
    ...
    final List<NotificationItem> list = [
      NotificationItem(
        id: 1,
        creator: UserInfo(id: 1, fullName: 'BBC News', image: Assets.images.bbc.path, isAuthor: true, follower: 10000),
      ...
      NotificationItem(
        id: 2,
        creator: UserInfo(id: 2, fullName: 'Modelyn Saris', image: Assets.images.saris.path, isAuthor: true, follower: 10000),
        action: UserAction.follow,
        sendAt: DateTime.now().subtract(const Duration(hours: 1)),
      ),
      NotificationItem(
        id: 3,
        creator: UserInfo(id: 3, fullName: 'Omar Merditz', image: Assets.images.omar.path, isAuthor: true, follower: 10000),
      ...
      NotificationItem(
        id: 4,
        creator: UserInfo(id: 4, fullName: 'Marley Botosh', image: Assets.images.marley.path, isAuthor: true, follower: 10000),
        action: UserAction.follow,
      ...
      NotificationItem(
        id: 6,
        creator:
            UserInfo(id: 5, fullName: 'CNN', image: Assets.images.cnn.path, isAuthor: true, follower: 10000),
        action: UserAction.posted,
